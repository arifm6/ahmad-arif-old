...
export default function Navbar() {
  ...
  return (
    ...
    <nav className={`flex flex-col justify-between w-[100vw] h-[100vh] fixed top-0 xl:fixed xl:w-[13rem] ${theme === "dark" ? "bg-[#0e181e]" : "bg-[#686565]"} ${menuOpen ? "" : "hidden"} xl:flex nav-transition`}>
        ...
        <ul className='flex flex-col text-center flex-1 mt-[4rem] [&>a:hover]:text-green-400 [&>a]:border-y-[1px] [&>a]:border-red-400 [&>a]:flex-1 [&>a]:p-4'>
          <a  href=''>About Me</a>
          <a  href=''>My Skills</a>
        ...
        <ul className='flex justify-center [&>a]:mx-[1rem] text-center flex-1 items-center [&>a:hover]:text-green-400'>
          <a className='' href=''>
